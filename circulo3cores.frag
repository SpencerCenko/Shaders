...
void main() {
    ...
    */
    ...
    float pulso =  (sin(u_time * 1.5) * 0.025);
    ...
    float de3 = 0.0;
    */
    float circulob = 1.0 - smoothstep(0.1, 0.105, d + pulso) - (1.0 - smoothstep(0.07, 0.075, d + pulso));
    float circulog = 1.0 - smoothstep(0.07, 0.075, d + pulso) - (1.0 - smoothstep(0.035, 0.04, d + pulso));
